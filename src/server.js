...
registerRoutes(app, { jsonRoot: false });

const apiRouter = express.Router();
registerRoutes(apiRouter, { jsonRoot: true });
...
app.use((req, res) => {
  return res.status(404).json({
    ...
    hint: "Check GET /, GET /api, or GET /api/index for available endpoints."
  });
});
